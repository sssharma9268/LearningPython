...
# Hint: In case of input data being supplied
# to the question, it should be assumed to be a
# console input.
# import re
#
...
#     print(str(a[i])+" at position: "+str(i))


# 5.
# Please   write   a   program   which
# accepts  a   string   from   console   and   print   the
...
# 9.
# By using
# list comprehension, please write a program to print the list after removing
# the value 24 in [12,24,35,24,88,120,155].
# lst = [12,24,35,24,88,120,155]
# lst = [value for value in lst if value != 24]
#
# print(lst)
#
# 10.
...
# inices = {0,4,5}
# lst = [value for value in lst if lst.index(value) not in inices]
# print(lst)
...
# lst=[12,24,35,70,88,120,155]
#
# lst =[value for value in lst if (value%5 != 0 and value%7 != 0)]
# print(lst)
